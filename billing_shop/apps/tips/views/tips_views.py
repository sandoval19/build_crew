...
from apps.tips.serializers.tips_serializer import TipsSerializer


class TipsView(viewsets.GenericViewSet):

    queryset = Tips.objects.filter(is_active=True).order_by('-create_at')

    def get_serializer_class(self):
        return TipsSerializer
